"""loyalty_app_19700 URL Configuration
...
admin.site.site_title = "Loyalty App Admin Portal"
admin.site.index_title = "Loyalty App Admin"

# swagger
api_info = openapi.Info(
    title="Loyalty App API",
    default_version="v1",
    description="API documentation for Loyalty App App",
)
